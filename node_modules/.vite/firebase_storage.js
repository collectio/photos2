    ...
    return __generator(this, function(_a) {
      switch (_a.label) {
        case 0:
          ...
          op = options || {};
          requestInfo = list$2(ref2.storage, ref2._location, "/", op.pageToken, op.maxResults);
...
var StorageService = function() {
  function StorageService2(app, _authProvider, _appCheckProvider, _pool, _url, _firebaseVersion) {
    this.app = app;
  ...
  Object.defineProperty(StorageService2.prototype, "host", {
    get: function() {
      return this._host;
    },
    set: function(host) {
  ...
  StorageService2.prototype._getAppCheckToken = function() {
    return __awaiter(this, void 0, void 0, function() {
      var appCheck, result;
      return __generator(this, function(_a) {
        switch (_a.label) {
  ...
  StorageService2.prototype._makeRequest = function(requestInfo, authToken, appCheckToken) {
    var _this = this;
    if (!this._deleted) {
  ...
  StorageService2.prototype.makeRequestWithTokens = function(requestInfo) {
    return __awaiter(this, void 0, void 0, function() {
...
var StorageServiceCompat = function() {
  ...
  StorageServiceCompat2.prototype.useEmulator = function(host, port) {
...
function factory(container, _a) {
  ...
  var storageServiceCompat = new StorageServiceCompat(app, new StorageService(app, authProvider, appCheckProvider, new ConnectionPool(), url, index_esm_default.SDK_VERSION));
